...
?>
                                    <!-- ALTERAÇÃO NO ALINHAMENTO DA ASSINATURA -->
                                    <table class="table table-bordered table-condensed">
                                        <tbody>
                                            <tr>                                            
                                                <td>
                                                <img class="assinatura" width="100" src="<?php echo($filePath); ?>" /> 
                                                <hr style='margin-bottom: 3px;'>
                                                    <span style='padding-left: 80px; '>Assinatura do Cliente</span>                                                    
                                                </td>
                                                <td>
                                                <img class="assinatura" width="100" src="<?php echo($filePathT); ?>" /> 
                                                <hr style='margin-bottom: 3px;'>   
                                                    <span style='padding-left: 80px; '>Assinatura do Técnico Responsável</span>                                                    
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <!-- FIM - ALTERAÇÃO NO ALINHAMENTO DA ASSINATURA -->
                                </div>
                            </div>
                        </div>
                    </div>

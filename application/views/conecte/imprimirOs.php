                                ...
                                <?php if ($emitente == null) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td> <span style="font-size: 20px; ">
                                                ...
                                                <i class="fas fa-fingerprint" style="margin:5px 1px"></i> <?php echo $emitente->cnpj; ?> </br>
                                                <i class="fas fa-map-marker-alt" style="margin:4px 3px"></i> <?php echo $emitente->rua . ', ' . $emitente->numero . ' - ' . $emitente->bairro . ' - ' . $emitente->cidade . ' - ' . $emitente->uf; ?> </span> </br> <span><i class="fas fa-comments" style="margin:5px 1px"></i> E-mail:
                                                <?php echo $emitente->email . ' - Fone: ' . $emitente->telefone; ?></span></td>
                                        <td style="width: 18%; text-align: center"><i class='fas fa-poll-h'></i> Protocolo: <span>
                                ...
                                <tr>
                                    <td style="width: 50%; padding-left: 0">
                                        <ul>
                                            <li>
                                                <span>
                                                    <h5><i class='fas fa-user-tie' style='color: red'></i> Cliente</h5>
                                                    <span>
                                    ...
                                    <td style="width: 50%; padding-left: 0">
                                        <ul>
                                            <li>
                                                <span>
                                                    <h5><i class='fas fa-user-cog' style='color: red'></i> Responsável</h5>
                                                </span>
                                                <span>

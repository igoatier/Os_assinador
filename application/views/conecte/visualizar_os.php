        ...
        <div class="widget-box">
            <div class="widget-title" style="margin: -20px 0 0">
                ...
                <div class="buttons">
                    ...
                    <a target="_blank" title="Imprimir" class="btn btn-mini btn-primary" href="<?php echo site_url() ?>/mine/imprimirOs/<?php echo $result->idOs; ?>"><i class="fas fa-print"></i> Imprimir</a>&nbsp; 
                    <!-- Adicione o botão "Assinar" -->
                    <a title="Assinar" class="btn btn-mini btn-danger" href="<?php echo site_url() ?>/mine/detalhesos/<?php echo $result->idOs .'?tab=5'; ?>"><i class="fas fa-pencil-alt"></i> Assinar</a>
                </div>
            </div>
